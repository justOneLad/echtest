...
var Checkbox = react_.forwardRef(
  (props, forwardedRef) => {
    ...
    return /* @__PURE__ */ (0,jsx_runtime_.jsxs)(CheckboxProvider, { scope: __scopeCheckbox, state: checked, disabled, children: [
...
var CheckboxIndicator = react_.forwardRef(
  (props, forwardedRef) => {
    ...
    return /* @__PURE__ */ (0,jsx_runtime_.jsx)(react_presence_dist/* Presence */.z, { present: forceMount || isIndeterminate(context.state) || context.state === true, children: /* @__PURE__ */ (0,jsx_runtime_.jsx)(
...
var DialogPortal = (props) => {
  ...
  return /* @__PURE__ */ (0,jsx_runtime_.jsx)(PortalProvider, { scope: __scopeDialog, forceMount, children: react_.Children.map(children, (child) => /* @__PURE__ */ (0,jsx_runtime_.jsx)(react_presence_dist/* Presence */.z, { present: forceMount || context.open, children: /* @__PURE__ */ (0,jsx_runtime_.jsx)(Portal, { asChild: true, container, children: child }) })) });
};
...
var ScrollArea = react_.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeScrollArea,
      type = "hover",
    ...
    const [scrollArea, setScrollArea] = react_.useState(null);
    const [viewport, setViewport] = react_.useState(null);
    const [content, setContent] = react_.useState(null);
    const [scrollbarX, setScrollbarX] = react_.useState(null);
    const [scrollbarY, setScrollbarY] = react_.useState(null);
    const [cornerWidth, setCornerWidth] = react_.useState(0);
    const [cornerHeight, setCornerHeight] = react_.useState(0);
    const [scrollbarXEnabled, setScrollbarXEnabled] = react_.useState(false);
    const [scrollbarYEnabled, setScrollbarYEnabled] = react_.useState(false);
...
var ScrollAreaViewport = react_.forwardRef(
  (props, forwardedRef) => {
...
var ScrollAreaScrollbar = react_.forwardRef(
  (props, forwardedRef) => {
...
var ScrollAreaScrollbarHover = react_.forwardRef((props, forwardedRef) => {
  const { forceMount, ...scrollbarProps } = props;
  const context = useScrollAreaContext(SCROLLBAR_NAME, props.__scopeScrollArea);
  const [visible, setVisible] = react_.useState(false);
  react_.useEffect(() => {
...
var ScrollAreaScrollbarScroll = react_.forwardRef((props, forwardedRef) => {
  const { forceMount, ...scrollbarProps } = props;
  const context = useScrollAreaContext(SCROLLBAR_NAME, props.__scopeScrollArea);
  const isHorizontal = props.orientation === "horizontal";
...
var ScrollAreaScrollbarAuto = react_.forwardRef((props, forwardedRef) => {
  const context = useScrollAreaContext(SCROLLBAR_NAME, props.__scopeScrollArea);
  const { forceMount, ...scrollbarProps } = props;
  const [visible, setVisible] = react_.useState(false);
  const isHorizontal = props.orientation === "horizontal";
...
var ScrollAreaScrollbarVisible = react_.forwardRef((props, forwardedRef) => {
  const { orientation = "vertical", ...scrollbarProps } = props;
  const context = useScrollAreaContext(SCROLLBAR_NAME, props.__scopeScrollArea);
  const thumbRef = react_.useRef(null);
  const pointerOffsetRef = react_.useRef(0);
  const [sizes, setSizes] = react_.useState({
    content: 0,
    viewport: 0,
...
var ScrollAreaScrollbarX = react_.forwardRef((props, forwardedRef) => {
  const { sizes, onSizesChange, ...scrollbarProps } = props;
  const context = useScrollAreaContext(SCROLLBAR_NAME, props.__scopeScrollArea);
  const [computedStyle, setComputedStyle] = react_.useState();
  const ref = react_.useRef(null);
...
var ScrollAreaScrollbarY = react_.forwardRef((props, forwardedRef) => {
  const { sizes, onSizesChange, ...scrollbarProps } = props;
  const context = useScrollAreaContext(SCROLLBAR_NAME, props.__scopeScrollArea);
  const [computedStyle, setComputedStyle] = react_.useState();
  const ref = react_.useRef(null);
...
var ScrollAreaScrollbarImpl = react_.forwardRef((props, forwardedRef) => {
  const {
    __scopeScrollArea,
    sizes,
    hasThumb,
  ...
  const [scrollbar, setScrollbar] = react_.useState(null);
  const composeRefs = (0,react_compose_refs_dist/* useComposedRefs */.e)(forwardedRef, (node) => setScrollbar(node));
  const rectRef = react_.useRef(null);
  const prevWebkitUserSelectRef = react_.useRef("");
  const viewport = context.viewport;
  ...
  react_.useEffect(handleThumbPositionChange, [sizes, handleThumbPositionChange]);
...
var ScrollAreaThumb = react_.forwardRef(
  (props, forwardedRef) => {
...
var ScrollAreaThumbImpl = react_.forwardRef(
  (props, forwardedRef) => {
    ...
    const removeUnlinkedScrollListenerRef = react_.useRef(void 0);
...
var ScrollAreaCorner = react_.forwardRef(
  (props, forwardedRef) => {
...
var ScrollAreaCornerImpl = react_.forwardRef((props, forwardedRef) => {
  const { __scopeScrollArea, ...cornerProps } = props;
  const context = useScrollAreaContext(CORNER_NAME, __scopeScrollArea);
  const [width, setWidth] = react_.useState(0);
  const [height, setHeight] = react_.useState(0);
...
function useDebounceCallback(callback, delay) {
  ...
  const debounceTimerRef = react_.useRef(0);
  react_.useEffect(() => () => window.clearTimeout(debounceTimerRef.current), []);
  return react_.useCallback(() => {
